          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-16">
            <div className="glass-effect p-6 rounded-xl hover-lift">
              <div className="text-ceramic-earth mb-3">
                <div className="w-12 h-12 bg-ceramic-earth/10 rounded-full flex items-center justify-center mx-auto text-2xl">
                  ⚱
                </div>
              </div>
            ...
            <div className="glass-effect p-6 rounded-xl hover-lift">
              <div className="text-ceramic-terracotta mb-3">
                <div className="w-12 h-12 bg-ceramic-terracotta/10 rounded-full flex items-center justify-center mx-auto text-2xl">
                  ✨
                </div>
              </div>
            ...
            <div className="glass-effect p-6 rounded-xl hover-lift">
              <div className="text-ceramic-warm mb-3">
                <div className="w-12 h-12 bg-ceramic-warm/10 rounded-full flex items-center justify-center mx-auto text-2xl">
                  ♻
                </div>
              </div>
