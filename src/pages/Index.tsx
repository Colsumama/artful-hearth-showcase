        ...
        <section id="contacto" className="py-20 bg-muted/30">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="https://wa.me/5491123456789?text=Hola! Me interesa conocer más sobre sus cerámicas artesanales."
                target="_blank"
              ...
              <a
                href="mailto:info@alfareriaartesanal.com"
                className="inline-flex items-center gap-2 border border-ceramic-earth text-ceramic-earth hover:bg-ceramic-earth hover:text-white px-8 py-3 rounded-lg font-semibold transition-colors"
              >
                <span>✉️</span>
                Enviar Email
              </a>
